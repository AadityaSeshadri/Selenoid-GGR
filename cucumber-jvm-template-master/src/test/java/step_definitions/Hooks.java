...
public class Hooks {
    ...
    // org.apache.log4j.Logger.getLogger(Hooks.class);
    ...
    // @Before("@Login")
    /*
     * public void first (Scenario scenario) { System.out.
     * println("*******************************mv ***********************************"
     * ); try { //Reusable_Functions.getData(scenario.getName()); } catch
     * (IOException e) {
    ...
    public void openBrowser(Scenario scenario) throws IOException {
         ...
         * { OS_Name = System.getProperty("os.name"); OS_Name =
         * OS_Name.contains("Windows")?
         * System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+
         * "\\src\\test\\resources\\Driver\\chromedriver.exe"):System.setProperty(
         * "webdriver.chrome.driver",System.getProperty("user.dir")+
         * "/src/test/resources/Driver/chromedriver_MAC"); ChromeOptions options = new
         * ChromeOptions(); //options.addArguments("headless"); //
         * options.addArguments("window-size=1200x600"); driver = new
         * ChromeDriver(options); }
         * if(Browser_To_Execute.equals("Chrome-Headless")||Browser_To_Execute.equals(
         * "chrome-headless")) { OS_Name = System.getProperty("os.name"); OS_Name =
         * OS_Name.contains("Windows")?
         * System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+
         * "\\src\\test\\resources\\Driver\\chromedriver.exe"):System.setProperty(
         * "webdriver.chrome.driver",System.getProperty("user.dir")+
         ...
         */
        /*
         * String FIREFOX = "firefox"; String IE = "ie"; String DEFAULT = "chrome";
         * String browser = System.getProperty("Browser"); System.out.println("browser"+
         * browser);
         * 
         * if(browser.equals("IE")) {
         * InternetExplorerDriverManager.getInstance().setup(); driver = new
         * InternetExplorerDriver();
         * 
         * } else if (browser.equals("CHROME")) {
         * ChromeDriverManager.getInstance().setup(); driver = new ChromeDriver();
         * 
         * } else if (browser.equals("CHROME-HEADLESS")) {
         * ChromeDriverManager.getInstance().setup(); ChromeOptions options = new
         * ChromeOptions(); options.addArguments("headless");
         * options.addArguments("window-size=1200x600"); driver = new
         * ChromeDriver(options);
         * 
         ...
         * 
         * } else if(browser.equals("HUB")) { DesiredCapabilities dr=null;
         * 
         * dr=DesiredCapabilities.chrome(); ChromeOptions chromeOptions = new
         * ChromeOptions(); chromeOptions.addArguments("--headless");
         * dr.setBrowserName("chrome"); dr.setCapability(ChromeOptions.CAPABILITY,
         * chromeOptions); dr.setPlatform(Platform.LINUX); driver=new
         * RemoteWebDriver(new URL("http://127.0.0.1:4444/wd/hub"), dr); }
         */
    ...
    public void embedScreenshot(Scenario scenario) {
        ...
        if (scenario.isFailed()) {
            /*
             * Log.info("******Failure Noted in scenario*****"+ scenario.getName()); try {
             * scenario.write("Current Page URL is " + driver.getCurrentUrl()); byte[]
             * screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.BYTES);
             * scenario.embed(screenshot, "image/png");
             * Log.info("Screenshot taken for error "); } catch (WebDriverException
             * somePlatformsDontSupportScreenshots) {
             * System.err.println(somePlatformsDontSupportScreenshots.getMessage()); }
             * Log.info("******Excecution  finished for the scenario*****"+
     ...
     * ; // Thread.sleep(2000); try { results.execute(true,true); } catch (Exception
     * e) { e.printStackTrace(); }
     * 
     * 
     * driver.quit();
